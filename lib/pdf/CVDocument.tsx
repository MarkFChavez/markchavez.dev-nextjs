    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.summary}>
          Software engineer with 10+ years of experience building web applications across childcare,
          healthcare, finance, and telecom industries. Deep expertise in Ruby on Rails, Hotwire, and Stimulus for creating modern,
